...
const MassSpringSolver::VectorXf& MassSpringSolver::getPrevState() const
{
	return prev_state;
}
const MassSpringSolver::Map& MassSpringSolver::getCurrentState() const
{
	return current_state;
}

float MassSpringSolver::getTimeStep() const
{
	return system->time_step;
}

const mass_spring_system::EdgeList& MassSpringSolver::getEdges() const
{
	return system->spring_list;
}
